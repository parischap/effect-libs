...
import { HOUR_MS, MINUTE_MS, SECOND_MS } from './date-time-constants.js';
 ...
 */
export const moduleTag = '@parischap/effect-lib/internal/DateTime/Time/';
