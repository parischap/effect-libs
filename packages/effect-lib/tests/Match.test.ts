    ...
    it('when', () => {
      TestUtils.strictEqual(
        pipe(
          5,
          MMatch.make,
          MMatch.when(Number.isGreaterThanOrEqualTo(6), Function.constant('a')),
          MMatch.when(Number.isLessThan(6), Function.constant('b')),
    ...
    it('whenAnd', () => {
      TestUtils.strictEqual(
        pipe(
          5,
          MMatch.make,
          MMatch.when(Number.isGreaterThan(7), Function.constant('a')),
          MMatch.whenAnd(Number.isLessThan(7), Number.isGreaterThan(3), Function.constant('b')),
          MMatch.orElse(Function.constant('c')),
        ),
        'b',
      );
