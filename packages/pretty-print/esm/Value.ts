...
export interface Type<out V> extends Equal.Equal, Inspectable.Inspectable, Pipeable.Pipeable {
	...
	/**
	 * `true` if the key was automatically generated by incrementing an integer from 0 (for iterables
	 * that only return a value). `false` otherwise
	 */
	readonly autogeneratedKey: boolean;
 ...
 * @category Guards
 */
export const isString = (u: All): u is Type<string> => MTypes.Category.isString(u.contentType);
 ...
 * @category Guards
 */
export const isNumber = (u: All): u is Type<number> => MTypes.Category.isNumber(u.contentType);
 ...
 * @category Guards
 */
export const isBigint = (u: All): u is Type<bigint> => MTypes.Category.isBigint(u.contentType);
 ...
 * @category Guards
 */
export const isBoolean = (u: All): u is Type<boolean> => MTypes.Category.isBoolean(u.contentType);
 ...
 * @category Guards
 */
export const isSymbol = (u: All): u is Type<symbol> => MTypes.Category.isSymbol(u.contentType);
 ...
 * @category Guards
 */
export const isUndefined = (u: All): u is Type<undefined> =>
	MTypes.Category.isUndefined(u.contentType);
 ...
 * @category Guards
 */
export const isNull = (u: All): u is Type<null> => MTypes.Category.isNull(u.contentType);
...
/**
 * Returns the `autogeneratedKey` property of `self`
 *
 * @category Destructors
 */
export const autogeneratedKey: MTypes.OneArgFunction<All, boolean> = Struct.get('autogeneratedKey');
