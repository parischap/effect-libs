...
![`treeify-with-leaves.svg`: image is not available](treeify-with-leaves.svg)
...
![`circularity-handling.svg`: image is not available](circularity-handling.svg)
...
![`with-date-and-regexp.svg`: image is not available](with-date-and-regexp.svg)
...
![`with-prototype-chain.svg`: image is not available](with-prototype-chain.svg)
...
![`with-custom-style-map.svg`: image is not available](with-custom-style-map.svg)
...
![`with-custom-primitive-formatter.svg`: image is not available](with-custom-primitive-formatter.svg)
...
![`with-property-filter-and-sort.svg`: image is not available](with-property-filter-and-sort.svg)
