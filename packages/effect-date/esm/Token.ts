...
/**
 * Creates a map that associates the name (short or long) of a month in the given locale to its number (1-12)
 */
...
/**
 * Creates a map that associates the name (short or long) of a weekday in the given locale to its number (1-12)
 */
...
/**
 * Converts a string representing a time zone offset in the form '+hh:mm' or '+hhmm' to its hour numeric value
 */
