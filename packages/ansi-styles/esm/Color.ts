/**
 * A very simple implementation of the colors defined in the Select Graphic Rendition subset. Info
 * at https://stackoverflow.com/questions/4842424/list-of-ansi-color-escape-sequences. A Color is
 * used to build a Formatter (see Formatter.ts) or a ContextFormatter (see ContextFormatter.ts). If
 * you need more styles than just a foreground color for your Formatter, you first need to build a
 * Format (see Format.ts) from your Color.
 *
 * With the fromCodes function of the RGB namespace, you can define your own instances if the
 * provided ones don't suit your needs.
 *
 * @since 0.0.1
 */
...
const moduleTag = '@parischap/ansi-styles/Color/';
...
export interface Type extends Equal.Equal, MInspectable.Inspectable, Pipeable.Pipeable {
	/**
	 * Name of this Color instance. Useful for equality and debugging
	 *
	 * @since 0.0.1
	 */
	...
	/**
	 * Foreground sequence that corresponds to this color
	 *
	 * @since 0.0.1
	 */
	...
	/**
	 * StringTransformer that sends the sequence string corresponding to this Color used as foreground
	 * color, then the string it receives as argument and finally the reset sequence.
	 *
	 * @since 0.0.1
	 */
...
export namespace TerminalDefault {
	 ...
	 */
	export const instance = _fromSequence({ name: 'TerminalDefaultColor', fgSequence: Array.of(39) });
}
...
export namespace Original {
	...
	/** Constructor for non-bright colors. Needs not be exported: all possible instances are available */
...
export namespace RGB {
	 ...
	 * @category RGB instances
	 */
	export const red: Type = _fromCodes({ name: 'RGBRed', redCode: 255, greenCode: 0, blueCode: 0 });
	/**
	 * RGB tomato color
	 *
	 * @since 0.0.1
