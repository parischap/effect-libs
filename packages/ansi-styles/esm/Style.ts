/**
 * This module defines Style, a callable type that applies ANSI formatting to text. Styles can be
 * composed and nested. For instance, `ASStyle.red('foo')` creates a text containing the string
 * 'foo' styled in red.
 */
