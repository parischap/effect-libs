/**
 * This module implements a ASContextStylerBase (see ContextStyler/Base.ts) that returns the same
 * style whetever the context object c. Note that it is a optimized particular case of an
 ...
 */
export const moduleTag = '@parischap/ansi-styles/ContextStyler/Constant/';
const _TypeId: unique symbol = Symbol.for(moduleTag) as _TypeId;
type _TypeId = typeof _TypeId;

/**
 * Type of an ASContextStylerConstant
 *
 * @category Models
 */
export class Type extends ASContextStylerBase.Type<never> {
  /** Style that is always returned by this ASContextStylerConstant */
  readonly style: ASStyle.Type;

  /** Function that takes a context c and returns an ASStyle */
  [ASContextStylerBase.toStyleSymbol](): ASStyle.Type {
    return this.style;
  }
...
/**
 * None ASContextStylerConstant instance: does not apply any style, does not provide a defaultText
 *
 * @category Instances
 */
