...
/**
 * `CVDateTimeFormat` instance for the ISO 8601 date-time format without milliseconds
 * (YYYY-MM-DDTHH:mm:ss, e.g. `2005-06-05T14:05:05`).
 *
 * @category Instances
 */
...
/**
 * `CVDateTimeFormat` instance for the ISO 8601 date-time format with milliseconds
 * (YYYY-MM-DDTHH:mm:ss.SSS, e.g. `2005-06-05T14:05:05.007`).
 *
 * @category Instances
 */
