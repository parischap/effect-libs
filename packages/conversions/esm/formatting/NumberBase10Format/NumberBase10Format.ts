...
/**
 * French-style integer `CVNumberBase10Format` instance. Used in countries like France, French-
 * speaking Canada, French-speaking Belgium, Denmark, Finland, Sweden...
 *
 * @category Instances
 */
...
/**
 * Uk-style integer `CVNumberBase10Format` instance. Used in countries like the UK, the US, English-
 * speaking Canada, Australia, Thaïland, Bosnia...
 *
 * @category Instances
 */
