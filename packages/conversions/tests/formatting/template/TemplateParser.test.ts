...
#MM: unsigned integer`,
  ...
  describe('parse', () => {
    ...
    it('Empty text', () => {
      TestUtils.assertFailureMessage(parser1(''), 'Expected length of #dd to be: 2. Actual: 0');
      TestUtils.assertFailureMessage(parser2(''), 'Expected length of #dd to be: 2. Actual: 0');
    });
    ...
    it('Matching text', () => {
      TestUtils.assertSuccess(parser1('05/12/2025 12'), {
        dd: 5,
        MM: 12,
        yyyy: 2025,
      });
      TestUtils.assertSuccess(parser2('05/12/2025 12'), {
        dd: 5,
        MM: 12,
        yyyy: 2025,
      });
